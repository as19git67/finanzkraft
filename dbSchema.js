  ...
  tables: [
    ...
    },
    {
      ...
      "values": [
        ...
        {name: "vergangene 1 Monate", fromRuleNo: 1, fromRuleAttribute: "1", order: 20},
        {name: "vergangene 3 Monate", fromRuleNo: 1, fromRuleAttribute: "3", order: 21},
        {name: "vergangene 6 Monate", fromRuleNo: 1, fromRuleAttribute: "6", order: 22},
        {name: "vergangene 12 Monate", fromRuleNo: 1, fromRuleAttribute: "12", order: 23},
        {name: "vergangene 24 Monate", fromRuleNo: 1, fromRuleAttribute: "24", order: 24},
        {name: "dieses Jahr", fromRuleNo: 2, order: 30},
        {name: "letztes Jahr", fromRuleNo: 3, order: 31},
        {name: "2022", fromRuleNo: 4, fromRuleAttribute: "2022", order: 35},
        {name: "2021", fromRuleNo: 4, fromRuleAttribute: "2021", order: 36},
        {name: "2020", fromRuleNo: 4, fromRuleAttribute: "2020", order: 37},
        {name: "diesen Monat", fromRuleNo: 5, fromRuleAttribute: "0", order: 1},
        {name: "letzten Monat", fromRuleNo: 5, fromRuleAttribute: "-1", order: 2},
        {name: "vorletzten Monat", fromRuleNo: 5, fromRuleAttribute: "-2", order: 3},
        {name: "vorvorletzten Monat", fromRuleNo: 5, fromRuleAttribute: "-3", order: 4},
        {name: "dieses Quartal", fromRuleNo: 6, fromRuleAttribute: "0", order: 5},
        {name: "letztes Quartal", fromRuleNo: 6, fromRuleAttribute: "-1", order: 6},
        {name: "vorletztes Quartal", fromRuleNo: 6, fromRuleAttribute: "-2", order: 7},
        {name: "Q1", fromRuleNo: 7, fromRuleAttribute: "0", order: 10},
        {name: "Q2", fromRuleNo: 7, fromRuleAttribute: "1", order: 11},
        {name: "Q3", fromRuleNo: 7, fromRuleAttribute: "2", order: 12},
        {name: "Q4", fromRuleNo: 7, fromRuleAttribute: "3", order: 13},
        {name: "Q1 letztes Jahr", fromRuleNo: 7, fromRuleAttribute: "-4", order: 14},
        {name: "Q2 letztes Jahr", fromRuleNo: 7, fromRuleAttribute: "-3", order: 15},
        {name: "Q3 letztes Jahr", fromRuleNo: 7, fromRuleAttribute: "-2", order: 16},
        {name: "Q4 letztes Jahr", fromRuleNo: 7, fromRuleAttribute: "-1", order: 17},
      ]
    },
    {
