...
ARG ARG_INITIALADMINUSER=""
ENV INITIALADMINUSER=${ARG_INITIALADMINUSER}
ARG ARG_INITIALADMINUSERPASSWORD=""
ENV INITIALADMINUSERPASSWORD=${ARG_INITIALADMINUSERPASSWORD}

ARG ARG_FINTSPRODUCTID=""
ENV FINTSPRODUCTID=${ARG_FINTSPRODUCTID}
ARG ARG_FINTSPRODUCTVERSION=""
ENV FINTSPRODUCTVERSION=${ARG_FINTSPRODUCTVERSION}
ARG ARG_PRIVATEKEYPASSPHRASE=""
ENV PRIVATEKEYPASSPHRASE=${ARG_PRIVATEKEYPASSPHRASE}
